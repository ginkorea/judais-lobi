...
CONFORMANCE: Dict[str, Any] = {
    ...
    "reads": {
        "mission_started": ("schema_version", "objective", "catalogue",
                            ...
                            "protocol", "granted", "history_checkpoint", "branch"),
        ...
        "tool_result": ("index", "tool", "arguments", "ok", "exit_code",
                        ...
                        "quoted_history", "receipt", "redacted_receipt", "branch"),
        ...
        "mission_finished": ("outcome", "steps", "max_steps",
                             "usage", "telemetry", "budget", "reason", "elapsed_s",
                             "stopped_with_draft", "task_state", "branch"),
    ...
    "env": ("MCP_TOKEN", "MCP_CLIENT_NAME", "MCP_URL", "MCP_STDIO",
            ...
            "LOCAL_MODEL", "JUDAIS_LOBI_MAX_OUTPUT_TOKENS", "JUDAIS_LOBI_OUTPUT_PROFILE",
            ...
            "JUDAIS_LOBI_GRAPH_CONTEXT", "JUDAIS_LOBI_SWARM_STEERING"),
