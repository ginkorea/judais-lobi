...
Still required: coherent native filesystem capture, platform composition,
current export-governance checks, publication/recovery and offline conflict
handling. This validator neither proves that omitted source files were captured
nor authorizes moving work to another host. See [integration boundaries](portable-checkpoints.md).
