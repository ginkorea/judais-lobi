...
#:
#: ``budget`` when the outcome is ``budget_exhausted``, naming which budget
#: ran out, and ``reason`` when the run was cancelled; see :data:`OPTIONAL`.
...
OPTIONAL: dict[str, tuple[str, ...]] = {
    ...
    MISSION_FINISHED: ("budget", "reason"),
}
